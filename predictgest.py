...
saver = tf.compat.v1.train.import_meta_graph('D:/Hand/Hand-Gesture-Recognition-Using-CNN-master/handgest_1.meta')
# Step-2: Now let's load the weights saved using the restore method.
saver.restore(sess, tf.compat.v1.train.latest_checkpoint('D:/Hand/Hand-Gesture-Recognition-Using-CNN-master/'))
